from PyQt5.QtWidgets import (QWidget, QVBoxLayout, QHBoxLayout, QLineEdit, QPushButton, QListWidget, QDialog)
...
class MainForm(QWidget):
    ...
    def SetupUi(self):
        self.resize(450, 350)
        self.move(300, 300)
        self.setWindowTitle('Phone Manager')
    ...
    def addButtonClick(self):
        ...
        if self.entryForm.exec_() == QDialog.Accepted:
            self.contactList.addItem(
                self.entryForm.nameLineEdit.text() + '-' + self.entryForm.phoneLineEdit.text()
            )
    ...
    def editButtonClick(self):
        ...
        self.entryForm.phoneLineEdit.setText(s[(idx + 1):])
